...
class train:
  ...
  file_list_path = '..\\..\\data\\synthetic_chinese_license_plates\\Synthetic_Chinese_License_Plates\\train'
...
class infer:
  ...
  file_list_path = '..\\..\\data\\synthetic_chinese_license_plates\\Synthetic_Chinese_License_Plates\\test_infer'
  checkpoint = ''
  batch_size = 1
